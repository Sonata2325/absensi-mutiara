    ...
    <div class="bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
        <div class="flex flex-wrap justify-evenly w-full">
            ...
            <a href="{{ route('karyawan.attendance.index') }}" class="group flex flex-col items-center gap-3">
                <div class="w-16 h-16 rounded-2xl bg-red-50 md:bg-gray-100 flex items-center justify-center text-[#D61600] md:text-gray-700 group-hover:bg-red-50 group-hover:text-[#D61600] transition-all duration-300 shadow-sm group-hover:shadow-md group-hover:scale-105">
                ...
                <span class="text-sm font-semibold text-[#D61600] md:text-gray-700 group-hover:text-[#D61600] transition-colors">Absensi</span>
            </a>
            ...
            <a href="{{ route('karyawan.leave.index') }}" class="group flex flex-col items-center gap-3">
                ...
                <span class="text-sm font-semibold text-[#D61600] md:text-gray-700 group-hover:text-[#D61600] transition-colors">Izin</span>
            </a>
            ...
            <a href="{{ route('karyawan.attendance.history') }}" class="group flex flex-col items-center gap-3">
                ...
                <span class="text-sm font-semibold text-[#D61600] md:text-gray-700 group-hover:text-[#D61600] transition-colors">Riwayat</span>
            </a>
