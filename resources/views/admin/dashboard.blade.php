...
@section('content')
<div class="max-w-6xl mx-auto px-2 sm:px-0 mt-8">
...
<div class="flex flex-col gap-6">
    <!-- Header Section -->
    <div class="bg-[#D61600] rounded-2xl p-6 shadow-lg flex flex-col md:flex-row items-center gap-6">
        
        <div class="flex-1 text-center md:text-left">
            <h1 class="text-2xl font-bold text-white tracking-tight">Dashboard Admin</h1>
            <p class="text-white/90 text-sm mt-1 font-medium tracking-wide">Ringkasan kehadiran dan aktivitas terbaru</p>
        </div>

        <div class="hidden md:flex items-center gap-2 text-white bg-white/10 px-4 py-2 rounded-xl border border-white/20 backdrop-blur-sm">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 md:gap-4">
        <a href="{{ route('admin.attendance.monitor') }}" class="bg-white p-4 md:p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md hover:border-red-100 transition group hover:-translate-y-0.5">
            <div class="w-10 h-10 md:w-12 md:h-12 mx-auto bg-red-50 rounded-xl flex items-center justify-center text-[#D61600] mb-3 group-hover:scale-105 transition duration-300">
            ...
            <h3 class="font-semibold text-gray-900 text-sm md:text-base text-center group-hover:text-[#D61600] transition-colors">Monitor</h3>
        </a>

        <a href="{{ route('admin.karyawan.index') }}" class="bg-white p-4 md:p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md hover:border-red-100 transition group hover:-translate-y-0.5">
            <div class="w-10 h-10 md:w-12 md:h-12 mx-auto bg-red-50 rounded-xl flex items-center justify-center text-[#D61600] mb-3 group-hover:scale-105 transition duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 md:w-6 md:h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                </svg>
            </div>
            <h3 class="font-semibold text-gray-900 text-sm md:text-base text-center group-hover:text-[#D61600] transition-colors">Karyawan</h3>
        </a>

        <a href="{{ route('admin.leave.index') }}" class="bg-white p-4 md:p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md hover:border-red-100 transition group hover:-translate-y-0.5">
            <div class="w-10 h-10 md:w-12 md:h-12 mx-auto bg-red-50 rounded-xl flex items-center justify-center text-[#D61600] mb-3 group-hover:scale-105 transition duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 md:w-6 md:h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
            </div>
            <h3 class="font-semibold text-gray-900 text-sm md:text-base text-center group-hover:text-[#D61600] transition-colors">Izin / Cuti</h3>
        </a>

        <a href="{{ route('admin.reports.index') }}" class="bg-white p-4 md:p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md hover:border-red-100 transition group hover:-translate-y-0.5">
            <div class="w-10 h-10 md:w-12 md:h-12 mx-auto bg-red-50 rounded-xl flex items-center justify-center text-[#D61600] mb-3 group-hover:scale-105 transition duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 md:w-6 md:h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
            </div>
            <h3 class="font-semibold text-gray-900 text-sm md:text-base text-center group-hover:text-[#D61600] transition-colors">Laporan</h3>
        </a>

        <a href="{{ route('admin.positions.index') }}" class="bg-white p-4 md:p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md hover:border-red-100 transition group hover:-translate-y-0.5">
            <div class="w-10 h-10 md:w-12 md:h-12 mx-auto bg-red-50 rounded-xl flex items-center justify-center text-[#D61600] mb-3 group-hover:scale-105 transition duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 md:w-6 md:h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
            </div>
            <h3 class="font-semibold text-gray-900 text-sm md:text-base text-center group-hover:text-[#D61600] transition-colors">Posisi</h3>
        </a>

        <a href="{{ route('admin.shifts.index') }}" class="bg-white p-4 md:p-5 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md hover:border-red-100 transition group hover:-translate-y-0.5">
            <div class="w-10 h-10 md:w-12 md:h-12 mx-auto bg-red-50 rounded-xl flex items-center justify-center text-[#D61600] mb-3 group-hover:scale-105 transition duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 md:w-6 md:h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
            </div>
            <h3 class="font-semibold text-gray-900 text-sm md:text-base text-center group-hover:text-[#D61600] transition-colors">Shift</h3>
        </a>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm hover:shadow-md hover:border-red-100 transition">
            <div class="flex flex-col md:flex-row md:items-center gap-4">
                <div class="p-3 bg-red-50 rounded-xl text-[#D61600] w-fit">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-4">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="{{ route('admin.attendance.monitor') }}" class="px-3 py-2 rounded-xl border border-gray-200 text-sm font-medium text-gray-700 hover:bg-red-50 hover:text-[#D61600] hover:border-red-200 transition">Monitor</a>
                <a href="{{ route('admin.reports.index') }}" class="px-3 py-2 rounded-xl border border-gray-200 text-sm font-medium text-gray-700 hover:bg-red-50 hover:text-[#D61600] hover:border-red-200 transition">Laporan</a>
            </div>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('admin.attendance.monitor') }}" class="text-sm text-[#D61600] hover:text-[#b91c1c] hover:underline font-medium">Lihat Detail</a>
        </div>
