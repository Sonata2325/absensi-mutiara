...
<form method="POST" action="{{ route('admin.departments.update', $department) }}" class="bg-white border rounded-2xl p-6 space-y-4">
    @csrf
    @method('PUT')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            ...
            <input name="nama_department" value="{{ old('nama_department', $department->nama_department) }}" class="mt-1 w-full border rounded-lg px-3 py-2" required>
        ...
        <div>
            ...
            <input name="kode_department" value="{{ old('kode_department', $department->kode_department) }}" class="mt-1 w-full border rounded-lg px-3 py-2" required>
    ...
    <div>
        ...
        <textarea name="deskripsi" class="mt-1 w-full border rounded-lg px-3 py-2" rows="3">{{ old('deskripsi', $department->deskripsi) }}</textarea>
