...
<form method="POST" action="{{ route('admin.karyawan.update', $employee) }}" class="bg-white border rounded-2xl p-6 space-y-4">
    @csrf
    @method('PUT')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
            ...
            <input name="email" type="email" value="{{ old('email', $employee->email) }}" class="mt-1 w-full border rounded-lg px-3 py-2" required>
        ...
        <div>
            ...
            <input name="phone" value="{{ old('phone', $employee->phone) }}" class="mt-1 w-full border rounded-lg px-3 py-2">
        ...
        <div>
            ...
            <input name="tanggal_masuk" type="date" value="{{ old('tanggal_masuk', optional($employee->tanggal_masuk)->toDateString()) }}" class="mt-1 w-full border rounded-lg px-3 py-2">
    ...
    <div>
        ...
        <textarea name="alamat" class="mt-1 w-full border rounded-lg px-3 py-2" rows="3">{{ old('alamat', $employee->alamat) }}</textarea>
    ...
    <div>
        ...
        <input name="kontak_darurat" value="{{ old('kontak_darurat', $employee->kontak_darurat) }}" class="mt-1 w-full border rounded-lg px-3 py-2">
